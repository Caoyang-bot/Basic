            ...
            <el-col :span="12">
                <el-form-item label="仪器类型" prop="toolType">
                    <el-select v-model="ruleForm.toolType" placeholder="仪器类型" filterable collapse-tags>
                        <el-option v-for="item in toolType" :key="item.id" :label="item.typeName" :value="item.id" />
                    </el-select>
                </el-form-item>
            </el-col>
            <el-col :span="12">
        ...
        <el-row>
            <el-col :span="12">
                <el-form-item label="控制要点" prop="controlPointName">
                    <el-select v-model="ruleForm.controlPointName" placeholder="控制要点" filterable collapse-tags>
                        <el-option v-for="item in controlPointName" :key="item.id" :label="item.controlPointName" :value="item.id" />
                    </el-select>
                </el-form-item>
            </el-col>
            <el-col :span="12">
