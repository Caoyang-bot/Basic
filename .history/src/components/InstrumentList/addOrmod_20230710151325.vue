        ...
        <el-row>
            <el-col :span="12">
                <el-form-item label="仪器类型" prop="toolType">
                    <el-select v-model="ruleForm.toolType" placeholder="仪器类型" filterable collapse-tags style="width: 100%">
            ...
            <el-col :span="12">
                <el-form-item label="仪器名称" prop="toolName">
                    <el-select v-model="ruleForm.toolName" placeholder="仪器名称" filterable collapse-tags style="width: 100%">
        ...
        <el-row>
            <el-col :span="12">
                <el-form-item label="校准类别" prop="manageType">
                    <el-select v-model="ruleForm.manageType" placeholder="校准类别" filterable collapse-tags style="width: 100%">
            ...
            <el-col :span="12">
                <el-form-item label="仪器规格" prop="toolspecs">
                    <el-select v-model="ruleForm.toolspecs" placeholder="仪器规格" filterable collapse-tags style="width: 100%">
        ...
        <el-row>
            <el-col :span="12">
                <el-form-item label="管理类别" prop="toolCategory">
                    <el-select v-model="ruleForm.toolCategory" placeholder="管理类别" filterable collapse-tags style="width: 100%">
            ...
            <el-col :span="12">
                <el-form-item label="精度单位" prop="precisionUnit">
                    <el-select v-model="ruleForm.precisionUnit" placeholder="精度单位" filterable collapse-tags style="width: 100%">
        ...
        <el-row>
            <el-col :span="12">
                <el-form-item label="控制要点" prop="controlPoint">
                    <el-select v-model="ruleForm.controlPoint" placeholder="控制要点" filterable collapse-tags style="width: 100%">
                        <el-option v-for="item in controlPoint" :key="item.id" :label="item.controlPointName" :value="item.id" />
                    </el-select>
                </el-form-item>
            </el-col>
            <el-col :span="12">
                <el-form-item label="制造单位" prop="supplier">
                    <el-select v-model="ruleForm.supplier" placeholder="制造单位" filterable collapse-tags style="width: 100%">
