<template>
  <div class="l-tab-content">
    <el-row>
      <el-col :span="24" style="height: 40px;">
        <el-button type="primary" @click="customerData.isShowForm = true">新增</el-button>

        <!-- <el-button>修改</el-button>
        <el-button type="danger" @click="Delete">删除</el-button> -->
        <el-input v-model="search" placeholder="仪器仪表名称/代号" clearable @input="inputSearch(search)"
    ...
    <el-table :data="InstrumentTable" border style="width: 100%; flex: 1;" size="small" @row-click="rowClick"
      ...
      <el-table-column prop="specs" label="精度单位" align="center" />
      <el-table-column prop="code" label="单位代号" align="center" />
  ...
  <el-dialog v-model="customerData.isShowForm" title="新增" width="20%" destroy-on-close>
