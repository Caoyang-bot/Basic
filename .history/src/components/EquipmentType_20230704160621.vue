<template>
  <div class="l-tab-content">
    ...
    <el-table :data="EquipmentTable" border style="width: 100%;" size="small" @row-click="rowClick" ref="table" :highlight-current-row="true">
...
<script setup>
import { ref, computed, watch, refs } from "vue"
