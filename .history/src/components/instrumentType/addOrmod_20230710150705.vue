<template>
    <el-form ref="ruleFormRef" :model="ruleForm" :rules="rules"  label-width="80px" tatus-icon>
    <el-row>
        <el-col>
            <el-form-item label="仪器类型" prop="typeName">
    ...
    <el-row>
        <el-col>
            <el-button type="primary" @click="submitForm(ruleFormRef)" style="flex-grow: 1;width: 100%;">
                {{ props.change ? "修改" : "提交" }}
            </el-button>
        </el-col>
