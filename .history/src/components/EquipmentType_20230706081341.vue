<template>
  <div class="l-tab-content">
    ...
    <el-table :data="EquipmentTable" border style="width: 100%;" size="small" @row-click="rowClick" ref="multipleTableRef"
    ...
    <el-pagination background layout="sizes, prev, pager, next,jumper" :total="cocustomerData.count_1" small
...
const confirmEvent = (row) => {
  ...
  axios.delete(baseUrl + "publicModule/equipmentName/", {
    data: {
      id: row.id
    }
  }).then(res => {
