  ...
  <div class="l-tab-content">
    <el-row>
      <el-col :span="24" style="height: 40px;">
        ...
        <el-input v-model="search" placeholder="控制要点/代号" clearable @input="inputSearch(search)"
    ...
    <el-table :data="InstrumentTable" border style="width: 100%; flex: 1;" size="small" @row-click="rowClick"
      ...
      <el-table-column prop="code" label="要点代号" align="center" />
...
const delEvent = (row, sign) => {
  ...
  // axios.delete(measureModule + "controlPoint/", {
  //   data: {
  //     id: row.id
  //   }
  // }).then(res => {
