<template>
  <div class="l-tab-content">
    ...
    <el-table :data="EquipmentTable" border style="width: 100%;" size="small" @row-click="rowClick"  @selection-change="handleSelectionChange" ref="multipleTableRef" :highlight-current-row="true">
