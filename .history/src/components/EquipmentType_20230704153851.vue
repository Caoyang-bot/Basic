<template>
  <div class="l-tab-content">
    ...
    <el-table :data="EquipmentTable" border style="width: 100%;" size="small" @row-click="rowClick" ref="EquipmentRef">
...
const EquipmentRef = ref<InstanceType<typeof ElTable>>()
...
//点击表格是触发
const rowClick = (row: Ref<Area>) =>{
  EquipmentRef.value?.toggleRowSelection(row)
